...
public class JsonFmUrl {
    private static final String TAG_PATH = "src\\example3";
    private static final String TAG_URL = "https://www.cbr-xml-daily.ru/daily_json.js";

    // Запись HashMap типа Map<String, Float> в Excel файл
    ...
    // Метод для консольного вывода - значение из HashMap типа Map<String, Float>
    ...
    /* Метод для поиска значения искомого атрибута в HashMap типа Map<String, Object> и запись
    ...
    // Метод для JSONObject в HashMap
